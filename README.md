# SDR
Code resource for the article "A Novel Shadow Variable Catcher for Addressing Selection Bias in Recommendation Systems"(https://ieeexplore.ieee.org/document/10884284) published at **ICDM 2024** .
...
Compared to the original neural collaborative recommendation system, the model constructed in this paper adds only one additional dot product operation during inference, while achieving a **15.37%** increase in metric NDGC@5 and a **10.01%** increase in metric Recall@5.
